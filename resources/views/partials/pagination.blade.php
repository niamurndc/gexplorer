...
<div class="d-flex justify-content-end">
    ...
    <nav aria-label="Page navigation example">
        ...
        <ul class="pagination">
            ...
            <li class="page-item"><a class="page-link @if($active_page == 1)bg-success text-light border border-success @else bg-dark border border-secondary text-success @endif" href="{{$page_link}}page=1">1</a></li>
            ...
            <li class="page-item"><a class="page-link @if($active_page == $i) bg-success text-light border border-success @else bg-dark border border-secondary text-success @endif" href="{{$page_link}}page={{$i}}">{{$i}}</a></li>
            ...
            <li class="page-item"><a class="page-link @if($active_page == $page_count)bg-success text-light border border-success @else bg-dark border border-secondary text-success @endif" href="{{$page_link}}page={{$page_count}}">{{$page_count}}</a></li>
